...
Also run `grep -rl "^> ⚠️ UNPOPULATED" docs/` — anchored to line start, since an unanchored grep self-matches this very rule. Any hit means bootstrap never captured that content: ask for it and write it in before any other work.
